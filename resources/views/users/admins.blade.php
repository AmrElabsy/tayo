			...
			<div class="col-12 col-sm-6">
				<div class="breadcrumb">
					<button class="btn btn-primary" type="button" data-bs-toggle="modal"
							data-bs-target="#add-modal">Add Profile
					</button>
				...
				<div class="col-md-6 col-lg-6 col-xl-4 box-col-4">
					<div class="card custom-card">
						...
						<div class="card-profile"><img class="rounded-circle"
													   src="{{ asset("storage/" . $admin->image) }}" alt=""></div>
						...
						<div class="card-footer row">
							<div class="col-6 col-sm-6">
								<button style="width: 100%" class="btn btn-primary" type="button" data-bs-toggle="modal"
										data-original-title="test" data-bs-target="#edit-modal-{{ $admin->id }}">Edit
								</button>
								<div class="modal fade" id="edit-modal-{{ $admin->id }}" tabindex="-1" role="dialog"
